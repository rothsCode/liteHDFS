...
public class CountDownLatch2 {
   ...
   * thread becomes disabled for thread scheduling purposes and lies dormant until one of two things
   * happen:
   * <ul>
   ...
   *
   * <p>If the current count is greater than zero then the current
   * thread becomes disabled for thread scheduling purposes and lies dormant until one of three
   * things happen:
   * <ul>
   * <li>The count reaches zero due to invocations of the
   * {@link #countDown} method; or
   ...
   * If the new count is zero then all waiting threads are re-enabled for thread scheduling
   * purposes.
   *
